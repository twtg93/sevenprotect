<?php 
	...
	if(isset($_SESSION['standby'])){
		...
		$_SESSION['standby'] = $_SESSION['standby']+1;
		 ...
		 $ad_dir = '/files';// directory with scripts
		...
		<div class="loading" style="margin-top: 11%;">
		  ...
		  <div class="loading__msg"><center><b style="font-size: 22px;">SevenProtect is checking you...</b><br><br>Do not worry, this is a simple security verfication, you will see this only one time!<br> Your webpage will show up soon.</center></div>
		</div>
